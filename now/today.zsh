...
alias lc="lc_l"
lc_l() {
    sudo sh -c "cd /var/snap/lxd/common/lxd/storage-pools/Jpool/images/ && exec \$SHELL"
}
...
alias lxcssp="lxc storage show Jpool"
alias lxcnl="lxc network list"
alias lxcnc=" sudo lxc network edit lxdbr0"

alias lxc0="lxc stop"
alias lxc1="lxc start"
alias lxcr="lxc restart Ubuntu"
alias lxce="sudo lxc exec Ubuntu --"
alias lxcinf="lxc info Ubuntu"
